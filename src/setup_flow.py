...
async def handle_configuration_mode(msg: UserDataResponse) -> RequestUserInput | SetupComplete | SetupError:
    ...
    match action:
        ...
        case "configure":
            ...
            return RequestUserInput(
                {
                    "en": "Configure your Panasonic Bluray",
                    "fr": "Configurez votre Bluray Panasonic",
                },
                [
                    {
...
async def _handle_discovery(msg: UserDataResponse) -> RequestUserInput | SetupError:
    ...
    if address:
        ...
        try:
            ...
            dropdown_items.append({"id": address, "label": {"en": f"Panasonic [{address}]"}})
    ...
    if not dropdown_items:
        _LOG.warning("No Panasonic device found")
